default:
	g++ /usr/local/include/GLFW/deps/glad.c *.cc -I/usr/local/include/GLFW/deps -I/usr/local/include/GLFW/ -L/usr/lib/x86_64-linux-gnu/ -Wl,--no-as-needed -lglfw3 -lGLU -lGL -lGLEW -lX11 -lXxf86vm -lXrandr -lpthread -lXi -ldl -lXinerama -lXcursor -lm -std=c++11 -o glrender
